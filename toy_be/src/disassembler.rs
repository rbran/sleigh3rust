pub fn meaning_94590049115392(value: usize) -> DisplayElement {
    match value {
...
impl RSVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 3usize] = [
            ...
            meaning_94590049115392(usize::try_from(*rs).unwrap()),
            DisplayElement::Literal("]"),
        ];
...
impl RTVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 3usize] = [
            DisplayElement::Literal("["),
            meaning_94590049115392(usize::try_from(*rt).unwrap()),
            DisplayElement::Literal("]"),
        ];
        display.extend_from_slice(&extend);
    }
...
impl instructionVar5 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 4usize] = [
            ...
            DisplayElement::Literal(" "),
            meaning_94590049115392(usize::try_from(*rd).unwrap()),
            DisplayElement::Literal(", "),
        ];
        display.extend_from_slice(&extend);
