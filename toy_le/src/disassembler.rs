pub fn meaning_94590154373808(value: usize) -> DisplayElement {
    match value {
...
impl instructionVar5 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 4usize] = [
            ...
            DisplayElement::Literal(" "),
            meaning_94590154373808(usize::try_from(*rd).unwrap()),
            DisplayElement::Literal(", "),
        ];
        display.extend_from_slice(&extend);
...
impl instructionVar7 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 3usize] = [
            ...
            DisplayElement::Literal(" "),
            meaning_94590154373808(usize::try_from(*rs).unwrap()),
        ];
        display.extend_from_slice(&extend);
    }
    pub fn parse<'a, T>(
...
impl instructionVar18 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 5usize] = [
            ...
            meaning_94590154373808(usize::try_from(*rs).unwrap()),
            DisplayElement::Literal(" "),
            meaning_94590154373808(usize::try_from(*rt).unwrap()),
        ];
        display.extend_from_slice(&extend);
    }
    pub fn parse<'a, T>(
