pub fn meaning_94590149703632(value: usize) -> DisplayElement {
    match value {
...
impl RSVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 3usize] = [
            DisplayElement::Literal("["),
            meaning_94590149703632(usize::try_from(*rs).unwrap()),
            DisplayElement::Literal("]"),
        ];
        display.extend_from_slice(&extend);
    }
...
impl instructionVar6 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 4usize] = [
            ...
            DisplayElement::Literal(" "),
            meaning_94590149703632(usize::try_from(*rd).unwrap()),
            DisplayElement::Literal(", "),
        ];
        display.extend_from_slice(&extend);
...
impl instructionVar25 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 5usize] = [
            ...
            meaning_94590149703632(usize::try_from(*rs).unwrap()),
            DisplayElement::Literal(" "),
            meaning_94590149703632(usize::try_from(*rt).unwrap()),
        ];
        display.extend_from_slice(&extend);
    }
    pub fn parse<'a, T>(
...
impl instructionVar45 {
    pub fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        let Self { nfctxSetAddr, Imm4 } = self;
        let extend: [DisplayElement; 2usize] = [
            DisplayElement::Literal("nfctx"),
            DisplayElement::Literal(" "),
        ];
        ...
        T: ContextTrait + Clone,
    {
        ...
        *context = context_current;
        Some((inst_len, Self { nfctxSetAddr, Imm4 }))
    }
}
