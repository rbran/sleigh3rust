    ...
    MemoryRead<AddressType = u16> + MemoryWrite<AddressType = u16>
{
    ...
    fn write_doPseudo_raw(&mut self, param: u8) {
        let mut mem = [0u8; 1];
    ...
    fn read_doPseudo_disassembly(&self) -> i64 {
        i64::try_from(self.read_doPseudo_raw()).unwrap()
    }
    fn write_doPseudo_disassembly(&mut self, param: i64) {
        self.write_doPseudo_raw(u8::try_from(param).unwrap())
    }
    fn read_doPseudo_execution(&self) -> u8 {
        self.read_doPseudo_raw()
    }
    fn write_doPseudo_execution(&mut self, param: u8) {
        self.write_doPseudo_raw(param)
    }
    fn doPseudo_display(&self) -> DisplayElement {
        meaning_number(true, self.read_doPseudo_raw())
    }
    fn read_possibleSkip_raw(&self) -> u8 {
        let mut work_value = [0u8; 1u64 as usize];
        self.read(0u64 as u16, &mut work_value[0..1]);
        let value = read_u8::<false>(work_value, 1u64 as usize, 1u64 as usize);
        u8::try_from(value).unwrap()
    }
    fn write_possibleSkip_raw(&mut self, param: u8) {
        let mut mem = [0u8; 1];
        self.read(0u64 as u16, &mut mem[0..1]);
        let mem = u8::from_le_bytes(mem);
        let mem =
    ...
    fn read_possibleSkip_disassembly(&self) -> i64 {
        i64::try_from(self.read_possibleSkip_raw()).unwrap()
    }
    fn write_possibleSkip_disassembly(&mut self, param: i64) {
        self.write_possibleSkip_raw(u8::try_from(param).unwrap())
    }
    fn read_possibleSkip_execution(&self) -> u8 {
        self.read_possibleSkip_raw()
    }
    fn write_possibleSkip_execution(&mut self, param: u8) {
        self.write_possibleSkip_raw(param)
    }
    fn possibleSkip_display(&self) -> DisplayElement {
        meaning_number(true, self.read_possibleSkip_raw())
    }
}
...
impl<const LEN: usize> TokenParser<LEN> {
    ...
    fn op12(&self) -> TokenField_op12 {
        let inner_value = {
            ...
            work_value[work_start..work_end]
                .copy_from_slice(&self.0[token_start..token_end]);
            let value =
                read_u16::<false>(work_value, 2u64 as usize, 12u64 as usize);
            u16::try_from(value).unwrap()
        };
    ...
    fn op11(&self) -> TokenField_op11 {
        let inner_value = {
            ...
            work_value[work_start..work_end]
                .copy_from_slice(&self.0[token_start..token_end]);
            let value =
                read_u16::<false>(work_value, 3u64 as usize, 11u64 as usize);
            u16::try_from(value).unwrap()
        };
    ...
    fn op9(&self) -> TokenField_op9 {
        let inner_value = {
            ...
            work_value[work_start..work_end]
                .copy_from_slice(&self.0[token_start..token_end]);
            let value =
                read_u16::<false>(work_value, 5u64 as usize, 9u64 as usize);
            u16::try_from(value).unwrap()
        };
    ...
    fn op7(&self) -> TokenField_op7 {
        let inner_value = {
            ...
            work_value[work_start..work_end]
                .copy_from_slice(&self.0[token_start..token_end]);
            let value =
                read_u16::<false>(work_value, 7u64 as usize, 7u64 as usize);
            u8::try_from(value).unwrap()
        };
    ...
    fn IntConBits(&self) -> TokenField_IntConBits {
        let inner_value = {
            let mut work_value = [0u8; 2u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 2u64 as usize;
        ...
        TokenField_IntConBits(inner_value)
    }
    fn StatusBit(&self) -> TokenField_StatusBit {
        let inner_value = {
            let mut work_value = [0u8; 2u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 2u64 as usize;
        ...
        TokenField_StatusBit(inner_value)
    }
    fn f7(&self) -> TokenField_f7 {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
        ...
        TokenField_f7(inner_value)
    }
    fn lf7(&self) -> TokenField_lf7 {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
        ...
        TokenField_lf7(inner_value)
    }
    fn uf7(&self) -> TokenField_uf7 {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
        ...
        TokenField_uf7(inner_value)
    }
    fn fsr(&self) -> TokenField_fsr {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
    ...
    fn fsrk(&self) -> TokenField_fsrk {
        ...
        TokenField_fsrk(inner_value)
    }
    fn fregCore(&self) -> TokenField_fregCore {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
        ...
        TokenField_fregCore(inner_value)
    }
    fn k5(&self) -> TokenField_k5 {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
        ...
        TokenField_k5(inner_value)
    }
    fn k7(&self) -> TokenField_k7 {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
    ...
    fn sk9(&self) -> TokenField_sk9 {
        let inner_value = {
            ...
            work_value[work_start..work_end]
                .copy_from_slice(&self.0[token_start..token_end]);
            let value =
                read_i16::<false>(work_value, 0u64 as usize, 9u64 as usize);
            i16::try_from(value).unwrap()
        };
        TokenField_sk9(inner_value)
    }
    fn k11(&self) -> TokenField_k11 {
        let inner_value = {
            let mut work_value = [0u8; 2u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 2u64 as usize;
        ...
        TokenField_k11(inner_value)
    }
    fn sk6(&self) -> TokenField_sk6 {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
        ...
        TokenField_sk6(inner_value)
    }
    fn l5(&self) -> TokenField_l5 {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
        ...
        TokenField_l5(inner_value)
    }
    fn mm(&self) -> TokenField_mm {
        let inner_value = {
            let mut work_value = [0u8; 1u64 as usize];
            let work_start = 0u64 as usize;
            let work_end = 1u64 as usize;
...
impl instructionVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if context_instance.register().read_possibleSkip_disassembly() != 1 {
            return None;
        }
        let tmp = (0u64 as i64);
        context_instance
...
impl instructionVar1 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.op6().disassembly() != 7 {
            return None;
        }
        if token_parser.d().disassembly() != 1 {
            return None;
        }
        if token_parser.f7().disassembly() != 2 {
            return None;
        }
...
impl instructionVar2 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 61 {
            return None;
        }
        if token_parser.d().disassembly() != 1 {
            return None;
...
impl instructionVar3 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op4().disassembly() != 4 {
            return None;
        }
        if token_parser.b3().disassembly() != 0 {
            return None;
        }
        if token_parser.f7().disassembly() != 3 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar9 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op4().disassembly() != 5 {
            return None;
        }
        if token_parser.b3().disassembly() != 0 {
            return None;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:531:1"]
#[derive(Clone, Debug)]
...
impl instructionVar15 {
    fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        let extend: [DisplayElement; 1usize] = [DisplayElement::Literal("BRW")];
        display.extend_from_slice(&extend);
    }
    fn parse<T>(
        mut tokens_current: &[u8],
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op14().disassembly() != 11 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar16 {
        ...
        T: ContextTrait + Clone,
    {
        global_set.set_possibleSkip(
            Some(inst_next),
            context.register().read_possibleSkip_disassembly(),
        );
        let extend: [DisplayElement; 4usize] = [
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op4().disassembly() != 6 {
            return None;
        }
        if token_parser.b3().disassembly() != 0 {
            return None;
...
impl instructionVar17 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if context_instance.register().read_doPseudo_disassembly() != 1 {
            return None;
        }
        if token_parser.op4().disassembly() != 6 {
            return None;
...
impl instructionVar18 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.op4().disassembly() != 7 {
            return None;
        }
        if token_parser.b3().disassembly() != 0 {
            return None;
...
impl instructionVar26 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op14().disassembly() != 10 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar27 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 1 {
            return None;
        }
        if token_parser.d().disassembly() != 1 {
            return None;
...
impl instructionVar28 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op14().disassembly() != 100 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar30 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op14().disassembly() != 98 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar31 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op14().disassembly() != 1 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar32 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op14().disassembly() != 9 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar33 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op14().disassembly() != 8 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar34 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op14().disassembly() != 99 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar35 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op12().disassembly() != 64 {
            return None;
        }
        let mm = token_parser.mm();
        pattern_len += block_0_len;
        tokens_current =
            &tokens_current[usize::try_from(block_0_len).unwrap()..];
        *context = context_instance;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:768:1"]
#[derive(Clone, Debug)]
...
impl instructionVar36 {
        ...
        T: ContextTrait + Clone,
    {
        let extend: [DisplayElement; 2usize] = [
            DisplayElement::Literal("MOVIW"),
            DisplayElement::Literal(" "),
        ];
        display.extend_from_slice(&extend);
        self.srcFSR.display_extend(
            display, context, inst_start, inst_next, global_set,
        );
    }
    fn parse<T>(
        ...
        T: ContextTrait + Clone,
    {
        ...
        let srcFSR = if let Some((len, table)) =
            srcFSR::parse(tokens_current, &mut context_instance, inst_start)
        {
            block_0_len = block_0_len.max(len as u16);
            table
        } else {
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:778:1"]
#[derive(Clone, Debug)]
...
impl instructionVar37 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op11().disassembly() != 3 {
            return None;
        }
        let srcFSR = if let Some((len, table)) =
            srcFSR::parse(tokens_current, &mut context_instance, inst_start)
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:786:1"]
#[derive(Clone, Debug)]
...
impl instructionVar38 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op9().disassembly() != 1 {
            return None;
        }
        let imm5 = if let Some((len, table)) =
            imm5::parse(tokens_current, &mut context_instance, inst_start)
        {
            block_0_len = block_0_len.max(len as u16);
            table
        } else {
...
impl instructionVar39 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.l5().disassembly() != 0 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl instructionVar40 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op9().disassembly() != 3 {
            return None;
        }
        let trisREG = if let Some((len, table)) =
            trisREG::parse(tokens_current, &mut context_instance, inst_start)
        {
            block_0_len = block_0_len.max(len as u16);
            table
        } else {
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:290:1"]
#[derive(Clone, Debug)]
struct instructionVar41 {
    fsrk: TokenField_fsrk,
    sk6: TokenField_sk6,
}
impl instructionVar41 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op7().disassembly() != 98 {
            return None;
        }
        let fsrk = token_parser.fsrk();
        let sk6 = token_parser.sk6();
        pattern_len += block_0_len;
        tokens_current =
            &tokens_current[usize::try_from(block_0_len).unwrap()..];
        *context = context_instance;
...
impl instructionVar42 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
        {
            block_0_len = block_0_len.max(len as u16);
            table
        } else {
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:773:1"]
#[derive(Clone, Debug)]
...
impl instructionVar43 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op7().disassembly() != 126 {
            return None;
        }
        let srcFSRk = if let Some((len, table)) =
            srcFSRk::parse(tokens_current, &mut context_instance, inst_start)
        {
            block_0_len = block_0_len.max(len as u16);
            table
        } else {
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:782:1"]
#[derive(Clone, Debug)]
...
impl instructionVar44 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op7().disassembly() != 127 {
            return None;
        }
        let srcFSRk = if let Some((len, table)) =
            srcFSRk::parse(tokens_current, &mut context_instance, inst_start)
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:790:1"]
#[derive(Clone, Debug)]
...
impl instructionVar45 {
    ...
    {
        let extend: [DisplayElement; 2usize] = [
            DisplayElement::Literal("MOVLP"),
            DisplayElement::Literal(" "),
        ];
        display.extend_from_slice(&extend);
        self.imm7.display_extend(
            display, context, inst_start, inst_next, global_set,
        );
    }
    fn parse<T>(
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op7().disassembly() != 99 {
            return None;
        }
        let imm7 = if let Some((len, table)) =
            imm7::parse(tokens_current, &mut context_instance, inst_start)
        {
            block_0_len = block_0_len.max(len as u16);
            table
        } else {
...
impl instructionVar47 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 62 {
            return None;
        }
...
impl instructionVar50 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 57 {
            return None;
        }
        let imm8 = if let Some((len, table)) =
            imm8::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar51 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 5 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar52 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 55 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar53 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.f7().disassembly() != 11 {
            return None;
        }
        let bit = if let Some((len, table)) =
            bit::parse(tokens_current, &mut context_instance, inst_start)
        ...
        let IntConBits = token_parser.IntConBits();
        pattern_len += block_0_len;
        tokens_current =
            &tokens_current[usize::try_from(block_0_len).unwrap()..];
        *context = context_instance;
...
impl instructionVar55 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 9 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar56 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 3 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar57 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 11 {
            return None;
        }
        let tmp = (1u64 as i64);
        context_instance
...
impl instructionVar58 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 10 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar59 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 15 {
            return None;
        }
        let tmp = (1u64 as i64);
        context_instance
...
impl instructionVar60 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 56 {
            return None;
        }
        let imm8 = if let Some((len, table)) =
            imm8::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar61 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 4 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:752:1"]
#[derive(Clone, Debug)]
...
impl instructionVar62 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 53 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:760:1"]
#[derive(Clone, Debug)]
...
impl instructionVar63 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 54 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar64 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 48 {
            return None;
        }
        let imm8 = if let Some((len, table)) =
            imm8::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar65 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 8 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar66 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 13 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar67 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 12 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar68 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 60 {
            return None;
        }
        let imm8 = if let Some((len, table)) =
            imm8::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar69 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 2 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar70 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 59 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar71 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 14 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar72 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 58 {
            return None;
        }
        let imm8 = if let Some((len, table)) =
            imm8::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar73 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op6().disassembly() != 6 {
            return None;
        }
        let srcREG = if let Some((len, table)) =
            srcREG::parse(tokens_current, &mut context_instance, inst_start)
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:527:1"]
#[derive(Clone, Debug)]
...
impl instructionVar74 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op5().disassembly() != 25 {
            return None;
        }
        let relAddr9 = if let Some((len, table)) =
            relAddr9::parse(tokens_current, &mut context_instance, inst_start)
        {
            block_0_len = block_0_len.max(len as u16);
            table
        } else {
...
impl instructionVar78 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op3().disassembly() != 5 {
            return None;
        }
        let absAddr11 = if let Some((len, table)) =
            absAddr11::parse(tokens_current, &mut context_instance, inst_start)
        {
...
impl instructionVar83 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op4().disassembly() != 13 {
            return None;
        }
        let imm8 = if let Some((len, table)) =
            imm8::parse(tokens_current, &mut context_instance, inst_start)
...
impl instructionVar84 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.op3().disassembly() != 4 {
            return None;
        }
        let absAddr11 = if let Some((len, table)) =
            absAddr11::parse(tokens_current, &mut context_instance, inst_start)
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:191:1"]
#[derive(Clone, Debug)]
struct srcREGVar0 {
...
impl srcREGVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 0 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
        tokens_current =
            &tokens_current[usize::try_from(block_0_len).unwrap()..];
        *context = context_instance;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:196:1"]
#[derive(Clone, Debug)]
struct srcREGVar1 {
    fregCore: TokenField_fregCore,
}
impl srcREGVar1 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 1 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
...
impl srcREGVar4 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 4 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:214:1"]
#[derive(Clone, Debug)]
struct srcREGVar5 {
    fregCore: TokenField_fregCore,
}
impl srcREGVar5 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 5 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:215:1"]
#[derive(Clone, Debug)]
struct srcREGVar6 {
    fregCore: TokenField_fregCore,
}
impl srcREGVar6 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 6 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:216:1"]
#[derive(Clone, Debug)]
struct srcREGVar7 {
    fregCore: TokenField_fregCore,
}
impl srcREGVar7 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 7 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:217:1"]
#[derive(Clone, Debug)]
struct srcREGVar8 {
    fregCore: TokenField_fregCore,
}
impl srcREGVar8 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 8 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:218:1"]
#[derive(Clone, Debug)]
struct srcREGVar9 {
    fregCore: TokenField_fregCore,
}
impl srcREGVar9 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 9 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
...
impl srcREGVar10 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.f7().disassembly() != 10 {
            return None;
        }
        let fregCore = token_parser.fregCore();
        pattern_len += block_0_len;
...
impl srcREGVar12 {
    ...
    {
        let mut fv: i64 = 0;
        fv = ((112u64 as i64) + self.lf7.disassembly());
        let extend: [DisplayElement; 1usize] =
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.uf7().disassembly() != 7 {
            return None;
        }
        let mut fv: i64 = 0;
        fv = ((112u64 as i64) + token_parser.lf7().disassembly());
        let lf7 = token_parser.lf7();
        pattern_len += block_0_len;
        tokens_current =
            &tokens_current[usize::try_from(block_0_len).unwrap()..];
        *context = context_instance;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:167:1"]
#[derive(Clone, Debug)]
struct srcREGVar13 {
    f7: TokenField_f7,
}
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:246:1"]
#[derive(Clone, Debug)]
struct relAddr9Var0 {
    sk9: TokenField_sk9,
}
impl relAddr9Var0 {
    ...
    {
        let mut addr: i64 = 0;
        addr = (i64::try_from(inst_next).unwrap() + self.sk9.disassembly());
        let extend: [DisplayElement; 1usize] =
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:257:1"]
#[derive(Clone, Debug)]
struct imm7Var0 {
    k7: TokenField_k7,
}
impl imm7Var0 {
    ...
    {
        let extend: [DisplayElement; 2usize] =
            [DisplayElement::Literal("#"), self.k7.display()];
        display.extend_from_slice(&extend);
    }
    fn parse<T>(
        mut tokens_current: &[u8],
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:260:1"]
#[derive(Clone, Debug)]
struct imm5Var0 {
    k5: TokenField_k5,
}
impl imm5Var0 {
    ...
    {
        let extend: [DisplayElement; 2usize] =
            [DisplayElement::Literal("#"), self.k5.display()];
        display.extend_from_slice(&extend);
    }
    fn parse<T>(
        mut tokens_current: &[u8],
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:272:1"]
#[derive(Clone, Debug)]
struct trisREGVar0 {}
impl trisREGVar0 {
    fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.l5().disassembly() != 5 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:273:1"]
#[derive(Clone, Debug)]
struct trisREGVar1 {}
impl trisREGVar1 {
    fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.l5().disassembly() != 6 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:274:1"]
#[derive(Clone, Debug)]
struct trisREGVar2 {}
impl trisREGVar2 {
    fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.l5().disassembly() != 7 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:743:1"]
#[derive(Clone, Debug)]
struct srcFSRVar0 {
    fsr: TokenField_fsr,
}
impl srcFSRVar0 {
    ...
    {
        let extend: [DisplayElement; 2usize] =
            [DisplayElement::Literal("++"), self.fsr.display()];
        display.extend_from_slice(&extend);
    }
    fn parse<T>(
        mut tokens_current: &[u8],
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.mm().disassembly() != 0 {
            return None;
        }
        let fsr = token_parser.fsr();
        pattern_len += block_0_len;
        tokens_current =
            &tokens_current[usize::try_from(block_0_len).unwrap()..];
        *context = context_instance;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:744:1"]
#[derive(Clone, Debug)]
struct srcFSRVar1 {
    fsr: TokenField_fsr,
}
impl srcFSRVar1 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.mm().disassembly() != 1 {
            return None;
        }
        let fsr = token_parser.fsr();
        pattern_len += block_0_len;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:745:1"]
#[derive(Clone, Debug)]
struct srcFSRVar2 {
    fsr: TokenField_fsr,
}
impl srcFSRVar2 {
    ...
    {
        let extend: [DisplayElement; 2usize] =
            [self.fsr.display(), DisplayElement::Literal("++")];
        display.extend_from_slice(&extend);
    }
    fn parse<T>(
        mut tokens_current: &[u8],
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.mm().disassembly() != 2 {
            return None;
        }
        let fsr = token_parser.fsr();
        pattern_len += block_0_len;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:746:1"]
#[derive(Clone, Debug)]
struct srcFSRVar3 {
    fsr: TokenField_fsr,
}
impl srcFSRVar3 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.mm().disassembly() != 3 {
            return None;
        }
        let fsr = token_parser.fsr();
        pattern_len += block_0_len;
...
#[doc = "Constructor at /home/rbran/src/ghidra/Ghidra/Processors/PIC/data/languages/pic16_instructions.sinc:748:1"]
#[derive(Clone, Debug)]
struct srcFSRkVar0 {
    sk6: TokenField_sk6,
    fsrk: TokenField_fsrk,
