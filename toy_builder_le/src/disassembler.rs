pub fn meaning_94590048989808(value: usize) -> DisplayElement {
    match value {
...
impl TokenParser8 {
    ...
    pub fn op8(&self) -> u8 {
        let mut raw_value = u8::from_le_bytes(self.0);
...
impl RSVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 3usize] = [
            DisplayElement::Literal("["),
            meaning_94590048989808(usize::try_from(*rs).unwrap()),
            DisplayElement::Literal("]"),
        ];
        display.extend_from_slice(&extend);
    }
...
impl RTVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 3usize] = [
            DisplayElement::Literal("["),
            meaning_94590048989808(usize::try_from(*rt).unwrap()),
            DisplayElement::Literal("]"),
        ];
        display.extend_from_slice(&extend);
    }
...
impl instructionVar6 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 4usize] = [
            ...
            DisplayElement::Literal(" "),
            meaning_94590048989808(usize::try_from(*rd).unwrap()),
            DisplayElement::Literal(", "),
        ];
        display.extend_from_slice(&extend);
...
impl instructionVar45 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((nfctxSetAddr, Imm4), (), block_len))
        };
        let ((mut nfctxSetAddr, mut Imm4), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
