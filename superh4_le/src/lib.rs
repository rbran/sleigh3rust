...
mod tests {
    ...
    fn disassembler_simple1() {
        let tokens: &[(u32, &str, &[u8])] = &[
            (0x0001_0000, "mov.l 0x10008,r0", &[0x01, 0xd0]),
            (0x0001_0002, "mov.l 0x10008,r1", &[0x01, 0xd1]),
            (0x0001_0004, "mov.l 0x10008,r2", &[0x00, 0xd2]),
            (0x0001_0006, "mov.l 0x10008,r3", &[0x00, 0xd3]),
            (0x0001_0008, "jsr @r0", &[0x0b, 0x40]),
        ];
