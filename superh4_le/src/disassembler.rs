pub fn meaning_94590154408880(value: usize) -> DisplayElement {
    match value {
...
pub fn meaning_94590180366576(value: usize) -> DisplayElement {
    match value {
...
pub fn meaning_94590181428640(value: usize) -> DisplayElement {
    match value {
...
pub fn meaning_94590257833952(value: usize) -> DisplayElement {
    match value {
...
pub fn meaning_94590133594912(value: usize) -> DisplayElement {
    match value {
...
pub fn meaning_94590142593312(value: usize) -> DisplayElement {
    match value {
...
pub fn meaning_94590182754560(value: usize) -> DisplayElement {
    match value {
        0usize => DisplayElement::Register(Register::dr0),
...
impl N_0t_vbrVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 3usize] = [
            meaning_94590181428640(usize::try_from(*N_0).unwrap()),
...
impl BANKtVar0 {
        ...
        T: ContextTrait + Clone,
    {
        let Self { BANK } = self;
        let extend: [DisplayElement; 1usize] =
            [meaning_94590133594912(usize::try_from(*BANK).unwrap())];
        display.extend_from_slice(&extend);
    }
    fn disassembly<'a, T>(
        &mut self,
...
impl U_2t_N0_dispr04Var0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            let N_0 = token_parser.N_0();
            *context = context_current;
            Some(((), (U_2, N_0), block_len))
        };
        let ((), (U_2, N_0), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let mut disp = 0i64;
...
impl FVN_2tVar0 {
        ...
        T: ContextTrait + Clone,
    {
        let Self { FVN_2 } = self;
        let extend: [DisplayElement; 1usize] =
            [meaning_94590257833952(usize::try_from(*FVN_2).unwrap())];
        display.extend_from_slice(&extend);
    }
    fn disassembly<'a, T>(
        &mut self,
...
impl U_2t_M0_dispr01Var0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 5usize] = [
            ...
            DisplayElement::Signed(true, *disp),
            DisplayElement::Literal(","),
            meaning_94590181428640(usize::try_from(*M_0).unwrap()),
            DisplayElement::Literal(")"),
        ];
        display.extend_from_slice(&extend);
    }
...
impl FVM_2tVar0 {
        ...
        T: ContextTrait + Clone,
    {
        let Self { FVM_2 } = self;
        let extend: [DisplayElement; 1usize] =
            [meaning_94590257833952(usize::try_from(*FVM_2).unwrap())];
        display.extend_from_slice(&extend);
    }
    fn disassembly<'a, T>(
        &mut self,
...
impl FRN_0tVar0 {
        ...
        T: ContextTrait + Clone,
    {
        let Self { FRN_0 } = self;
        let extend: [DisplayElement; 1usize] =
            [meaning_94590154408880(usize::try_from(*FRN_0).unwrap())];
        display.extend_from_slice(&extend);
    }
    fn disassembly<'a, T>(
        &mut self,
...
impl instructionVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        *context = context_current;
        Some((inst_len, Self { FVN_2t, XMTRX_t }))
    }
}
...
impl instructionVar4 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((N_0t_at_neg, fpscr_t), (), block_len))
        };
        let ((mut N_0t_at_neg, mut fpscr_t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar10 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((mach_t, N_0t_at_neg), (), block_len))
        };
        let ((mut mach_t, mut N_0t_at_neg), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar14 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((dbr_t, N_0t_at_neg), (), block_len))
        };
        let ((mut dbr_t, mut N_0t_at_neg), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar15 {
    pub fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        let Self { sgr_t, N_0t_at_neg } = self;
        let extend: [DisplayElement; 2usize] = [
            DisplayElement::Literal("stc.l"),
            DisplayElement::Literal(" "),
        ];
        ...
        T: ContextTrait + Clone,
    {
        ...
        *context = context_current;
        Some((inst_len, Self { sgr_t, N_0t_at_neg }))
    }
}
...
impl instructionVar16 {
    pub fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        let Self { spc_t, N_0t_at_neg } = self;
        let extend: [DisplayElement; 2usize] = [
            DisplayElement::Literal("stc.l"),
            DisplayElement::Literal(" "),
        ];
        ...
        T: ContextTrait + Clone,
    {
        ...
        *context = context_current;
        Some((inst_len, Self { spc_t, N_0t_at_neg }))
    }
}
...
impl instructionVar17 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((N_0t_at_neg, ssr_t), (), block_len))
        };
        let ((mut N_0t_at_neg, mut ssr_t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar18 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((vbr_t, N_0t_at_neg), (), block_len))
        };
        let ((mut vbr_t, mut N_0t_at_neg), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar19 {
    pub fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        let Self { N_0t_at_neg, gbr_t } = self;
        let extend: [DisplayElement; 2usize] = [
            DisplayElement::Literal("stc.l"),
            DisplayElement::Literal(" "),
        ];
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((gbr_t, N_0t_at_neg), (), block_len))
        };
        let ((mut gbr_t, mut N_0t_at_neg), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
        ...
        *context = context_current;
        Some((inst_len, Self { N_0t_at_neg, gbr_t }))
    }
}
...
impl instructionVar20 {
    pub fn display_extend<T>(
        ...
        T: ContextTrait + Clone,
    {
        let Self { N_0t_at_neg, sr_t } = self;
        let extend: [DisplayElement; 2usize] = [
            DisplayElement::Literal("stc.l"),
            DisplayElement::Literal(" "),
        ];
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((N_0t_at_neg, sr_t), (), block_len))
        };
        let ((mut N_0t_at_neg, mut sr_t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
        ...
        *context = context_current;
        Some((inst_len, Self { N_0t_at_neg, sr_t }))
    }
}
...
impl instructionVar79 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((FVN_2t, FVM_2t), (), block_len))
        };
        let ((mut FVN_2t, mut FVM_2t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
        ...
        *context = context_current;
        Some((inst_len, Self { FVN_2t, FVM_2t }))
    }
}
...
impl instructionVar113 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        *context = context_current;
        Some((inst_len, Self { M_0t_at1, N_0t }))
    }
}
...
impl instructionVar117 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        *context = context_current;
        Some((inst_len, Self { N_0t_at1, M_0t }))
    }
}
...
impl instructionVar120 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((N_0t_at, M_0t_at), (), block_len))
        };
        let ((mut N_0t_at, mut M_0t_at), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar121 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((DRM_1t, FRM_0t, FRN_0t, DRN_1t), (), block_len))
        };
        let ((mut DRM_1t, mut FRM_0t, mut FRN_0t, mut DRN_1t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar122 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((FRN_0t, DRM_1t, DRN_1t, FRM_0t), (), block_len))
        };
        let ((mut FRN_0t, mut DRM_1t, mut DRN_1t, mut FRM_0t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar123 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((FRN_0t, FR0_t, FRM_0t), (), block_len))
        };
        let ((mut FRN_0t, mut FR0_t, mut FRM_0t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar124 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((DRM_1t, FRN_0t, DRN_1t, FRM_0t), (), block_len))
        };
        let ((mut DRM_1t, mut FRN_0t, mut DRN_1t, mut FRM_0t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar125 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((FRM_0t, DRN_1t, FRN_0t, DRM_1t), (), block_len))
        };
        let ((mut FRM_0t, mut DRN_1t, mut FRN_0t, mut DRM_1t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar168 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((M_0t, U_2t_M0_dispr01), (), block_len))
        };
        let ((mut M_0t, mut U_2t_M0_dispr01), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar185 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((U_2t_N0_dispr04, N_0t, M_0t), (), block_len))
        };
        let ((mut U_2t_N0_dispr04, mut N_0t, mut M_0t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar187 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((U_0t_2pc, N_0t), (), block_len))
        };
        let ((mut U_0t_2pc, mut N_0t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
        ...
        *context = context_current;
        Some((inst_len, Self { U_0t_2pc, N_0t }))
    }
}
...
impl instructionVar188 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((I_0t, N_0t), (), block_len))
        };
        let ((mut I_0t, mut N_0t), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar197 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 5usize] = [
            ...
            DisplayElement::Literal(" "),
            meaning_94590154408880(usize::try_from(*FRM_0).unwrap()),
            DisplayElement::Literal(","),
            meaning_94590154408880(usize::try_from(*FRN_0).unwrap()),
        ];
        display.extend_from_slice(&extend);
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((), (FRM_0, FRN_0, XDRM, XDRN), block_len))
        };
        let ((), (FRM_0, FRN_0, XDRM, XDRN), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar198 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((), (FRM_0, DRN_1, DRM_1, FRN_0), block_len))
        };
        let ((), (FRM_0, DRN_1, DRM_1, FRN_0), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar199 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((N_0t_at_with_r0), (FRM_0, XDRM), block_len))
        };
        let ((mut N_0t_at_with_r0), (FRM_0, XDRM), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar200 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((M_0t_at_with_r0), (FRN_0, XDRN), block_len))
        };
        let ((mut M_0t_at_with_r0), (FRN_0, XDRN), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar202 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((M_0t_at), (FRN_0, XDRN), block_len))
        };
        let ((mut M_0t_at), (FRN_0, XDRN), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar203 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((N_0t_at1), (XDRM, FRM_0), block_len))
        };
        let ((mut N_0t_at1), (XDRM, FRM_0), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
...
impl instructionVar205 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((FRN_0t, DRM_1t, FRM_0t, DRN_1t), (OP_6, OP_10), block_len))
        };
        let (
            (mut FRN_0t, mut DRM_1t, mut FRM_0t, mut DRN_1t),
            (OP_6, OP_10),
            block_len,
        ) = block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
...
impl instructionVar209 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0 = |tokens, context: &mut T| {
            ...
            *context = context_current;
            Some(((N_0t_bank, BANKt), (), block_len))
        };
        let ((mut N_0t_bank, mut BANKt), (), block_len) =
            block_0(token_current, &mut context_current)?;
        token_current = &token_current[usize::try_from(block_len).unwrap()..];
        inst_len += block_len;
        let inst_next = inst_start + inst_len;
        ...
        *context = context_current;
        Some((inst_len, Self { BANKt, N_0t_bank }))
    }
}
...
impl DRM_1tVar0 {
        ...
        T: ContextTrait + Clone,
    {
        let Self { DRM_1 } = self;
        let extend: [DisplayElement; 1usize] =
            [meaning_94590180366576(usize::try_from(*DRM_1).unwrap())];
        display.extend_from_slice(&extend);
    }
    fn disassembly<'a, T>(
        &mut self,
...
impl DRN_1tVar0 {
        ...
        T: ContextTrait + Clone,
    {
        let Self { DRN_1 } = self;
        let extend: [DisplayElement; 1usize] =
            [meaning_94590180366576(usize::try_from(*DRN_1).unwrap())];
        display.extend_from_slice(&extend);
    }
    fn disassembly<'a, T>(
        &mut self,
