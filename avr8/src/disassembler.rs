...
pub trait GlobalSetTrait {
    fn set_useSkipCond(&mut self, address: Option<u16>, value: i128);
    fn set_phase(&mut self, address: Option<u16>, value: i128);
}
#[derive(Default)]
...
impl<const LEN: usize> TokenParser<LEN> {
    ...
    fn TokenFieldRdHi3(&self) -> TokenField_RdHi3 {
        let inner_value = self.read_u8::<false>(0, 4, 3).unwrap();
        TokenField_RdHi3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRdFull(&self) -> TokenField_RdFull {
        let inner_value = self.read_u16::<false>(0, 4, 5).unwrap();
        TokenField_RdFull(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRrHi(&self) -> TokenField_RrHi {
        let inner_value = self.read_u8::<false>(0, 0, 4).unwrap();
        TokenField_RrHi(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRrHi3(&self) -> TokenField_RrHi3 {
        let inner_value = self.read_u8::<false>(0, 0, 3).unwrap();
        TokenField_RrHi3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRrLow(&self) -> TokenField_RrLow {
        let inner_value = self.read_u8::<false>(0, 0, 4).unwrap();
        TokenField_RrLow(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRrHiLowSel(&self) -> TokenField_RrHiLowSel {
        let inner_value = self.read_u8::<false>(1, 1, 1).unwrap();
        TokenField_RrHiLowSel(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRdw2(&self) -> TokenField_Rdw2 {
        let inner_value = self.read_u8::<false>(0, 4, 2).unwrap();
        TokenField_Rdw2(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRdw4(&self) -> TokenField_Rdw4 {
        let inner_value = self.read_u8::<false>(0, 4, 4).unwrap();
        TokenField_Rdw4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRrw4(&self) -> TokenField_Rrw4 {
        let inner_value = self.read_u8::<false>(0, 0, 4).unwrap();
        TokenField_Rrw4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRstq(&self) -> TokenField_Rstq {
        let inner_value = self.read_u8::<false>(0, 3, 1).unwrap();
        TokenField_Rstq(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldRstPtr(&self) -> TokenField_RstPtr {
        let inner_value = self.read_u8::<false>(0, 2, 2).unwrap();
        TokenField_RstPtr(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop0to3(&self) -> TokenField_op0to3 {
        let inner_value = self.read_u8::<false>(0, 0, 4).unwrap();
        TokenField_op0to3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop3to9signed(&self) -> TokenField_op3to9signed {
        let inner_value = self.read_i16::<false>(0, 3, 7).unwrap();
        TokenField_op3to9signed(i8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop4to7(&self) -> TokenField_op4to7 {
        let inner_value = self.read_u8::<false>(0, 4, 4).unwrap();
        TokenField_op4to7(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop8to11(&self) -> TokenField_op8to11 {
        let inner_value = self.read_u8::<false>(1, 0, 4).unwrap();
        TokenField_op8to11(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldnext16(&self) -> TokenField_next16 {
        let inner_value = self.read_u16::<false>(0, 0, 16).unwrap();
        TokenField_next16(u16::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1hi4(&self) -> TokenField_op1hi4 {
        let inner_value = self.read_u8::<false>(1, 4, 4).unwrap();
        TokenField_op1hi4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2hi4(&self) -> TokenField_op2hi4 {
        let inner_value = self.read_u8::<false>(3, 4, 4).unwrap();
        TokenField_op2hi4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1hi6(&self) -> TokenField_op1hi6 {
        let inner_value = self.read_u8::<false>(1, 2, 6).unwrap();
        TokenField_op1hi6(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2hi6(&self) -> TokenField_op2hi6 {
        let inner_value = self.read_u8::<false>(3, 2, 6).unwrap();
        TokenField_op2hi6(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1low4(&self) -> TokenField_op1low4 {
        let inner_value = self.read_u8::<false>(0, 0, 4).unwrap();
        TokenField_op1low4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2low4(&self) -> TokenField_op2low4 {
        let inner_value = self.read_u8::<false>(2, 0, 4).unwrap();
        TokenField_op2low4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bits0to3(&self) -> TokenField_op1bits0to3 {
        let inner_value = self.read_u8::<false>(0, 0, 4).unwrap();
        TokenField_op1bits0to3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bits0to3(&self) -> TokenField_op2bits0to3 {
        let inner_value = self.read_u8::<false>(2, 0, 4).unwrap();
        TokenField_op2bits0to3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bits1to3(&self) -> TokenField_op1bits1to3 {
        let inner_value = self.read_u8::<false>(0, 1, 3).unwrap();
        TokenField_op1bits1to3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bits1to3(&self) -> TokenField_op2bits1to3 {
        let inner_value = self.read_u8::<false>(2, 1, 3).unwrap();
        TokenField_op2bits1to3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bits4to8(&self) -> TokenField_op1bits4to8 {
        let inner_value = self.read_u16::<false>(0, 4, 5).unwrap();
        TokenField_op1bits4to8(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bits4to8(&self) -> TokenField_op2bits4to8 {
        let inner_value = self.read_u16::<false>(2, 4, 5).unwrap();
        TokenField_op2bits4to8(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bits5to7(&self) -> TokenField_op1bits5to7 {
        let inner_value = self.read_u8::<false>(0, 5, 3).unwrap();
        TokenField_op1bits5to7(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bits5to7(&self) -> TokenField_op2bits5to7 {
        let inner_value = self.read_u8::<false>(2, 5, 3).unwrap();
        TokenField_op2bits5to7(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bits5to8(&self) -> TokenField_op1bits5to8 {
        let inner_value = self.read_u16::<false>(0, 5, 4).unwrap();
        TokenField_op1bits5to8(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bits5to8(&self) -> TokenField_op2bits5to8 {
        let inner_value = self.read_u16::<false>(2, 5, 4).unwrap();
        TokenField_op2bits5to8(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bits8to11(&self) -> TokenField_op1bits8to11 {
        let inner_value = self.read_u8::<false>(1, 0, 4).unwrap();
        TokenField_op1bits8to11(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bits8to11(&self) -> TokenField_op2bits8to11 {
        let inner_value = self.read_u8::<false>(3, 0, 4).unwrap();
        TokenField_op2bits8to11(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bit0(&self) -> TokenField_op1bit0 {
        let inner_value = self.read_u8::<false>(0, 0, 1).unwrap();
        TokenField_op1bit0(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bit0(&self) -> TokenField_op2bit0 {
        let inner_value = self.read_u8::<false>(2, 0, 1).unwrap();
        TokenField_op2bit0(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bit4(&self) -> TokenField_op1bit4 {
        let inner_value = self.read_u8::<false>(0, 4, 1).unwrap();
        TokenField_op1bit4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bit4(&self) -> TokenField_op2bit4 {
        let inner_value = self.read_u8::<false>(2, 4, 1).unwrap();
        TokenField_op2bit4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1bit9(&self) -> TokenField_op1bit9 {
        let inner_value = self.read_u8::<false>(1, 1, 1).unwrap();
        TokenField_op1bit9(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop2bit9(&self) -> TokenField_op2bit9 {
        let inner_value = self.read_u8::<false>(3, 1, 1).unwrap();
        TokenField_op2bit9(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1RdPair(&self) -> TokenField_op1RdPair {
        let inner_value = self.read_u16::<false>(0, 5, 4).unwrap();
        TokenField_op1RdPair(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1RdPairHi(&self) -> TokenField_op1RdPairHi {
        let inner_value = self.read_u8::<false>(0, 5, 3).unwrap();
        TokenField_op1RdPairHi(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1RrPairLow(&self) -> TokenField_op1RrPairLow {
        let inner_value = self.read_u8::<false>(0, 1, 3).unwrap();
        TokenField_op1RrPairLow(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1RrPairHi(&self) -> TokenField_op1RrPairHi {
        let inner_value = self.read_u8::<false>(0, 1, 3).unwrap();
        TokenField_op1RrPairHi(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldop1RrPairSel(&self) -> TokenField_op1RrPairSel {
        let inner_value = self.read_u8::<false>(1, 1, 1).unwrap();
        TokenField_op1RrPairSel(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op1hi4(&self) -> TokenField_f3op1hi4 {
        let inner_value = self.read_u8::<false>(1, 4, 4).unwrap();
        TokenField_f3op1hi4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op2hi4(&self) -> TokenField_f3op2hi4 {
        let inner_value = self.read_u8::<false>(3, 4, 4).unwrap();
        TokenField_f3op2hi4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op3hi4(&self) -> TokenField_f3op3hi4 {
        let inner_value = self.read_u16::<false>(4, 2, 14).unwrap();
        TokenField_f3op3hi4(u16::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op1hi6(&self) -> TokenField_f3op1hi6 {
        let inner_value = self.read_u8::<false>(1, 2, 6).unwrap();
        TokenField_f3op1hi6(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op2hi6(&self) -> TokenField_f3op2hi6 {
        let inner_value = self.read_u8::<false>(3, 2, 6).unwrap();
        TokenField_f3op2hi6(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op3hi6(&self) -> TokenField_f3op3hi6 {
        let inner_value = self.read_u8::<false>(5, 2, 6).unwrap();
        TokenField_f3op3hi6(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op1bits0to3(&self) -> TokenField_f3op1bits0to3 {
        let inner_value = self.read_u8::<false>(0, 0, 4).unwrap();
        TokenField_f3op1bits0to3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op2bits0to3(&self) -> TokenField_f3op2bits0to3 {
        let inner_value = self.read_u8::<false>(2, 0, 4).unwrap();
        TokenField_f3op2bits0to3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op3bits0to3(&self) -> TokenField_f3op3bits0to3 {
        let inner_value = self.read_u8::<false>(4, 0, 4).unwrap();
        TokenField_f3op3bits0to3(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op2bits4to7(&self) -> TokenField_f3op2bits4to7 {
        let inner_value = self.read_u8::<false>(2, 4, 4).unwrap();
        TokenField_f3op2bits4to7(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op1bits5to7(&self) -> TokenField_f3op1bits5to7 {
        let inner_value = self.read_u8::<false>(0, 5, 3).unwrap();
        TokenField_f3op1bits5to7(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op3bits5to7(&self) -> TokenField_f3op3bits5to7 {
        let inner_value = self.read_u8::<false>(4, 5, 3).unwrap();
        TokenField_f3op3bits5to7(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op1bits8to11(&self) -> TokenField_f3op1bits8to11 {
        let inner_value = self.read_u8::<false>(1, 0, 4).unwrap();
        TokenField_f3op1bits8to11(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op2bits8to11(&self) -> TokenField_f3op2bits8to11 {
        let inner_value = self.read_u8::<false>(3, 0, 4).unwrap();
        TokenField_f3op2bits8to11(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op1bit4(&self) -> TokenField_f3op1bit4 {
        let inner_value = self.read_u8::<false>(0, 4, 1).unwrap();
        TokenField_f3op1bit4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op3bit4(&self) -> TokenField_f3op3bit4 {
        let inner_value = self.read_u8::<false>(4, 4, 1).unwrap();
        TokenField_f3op3bit4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op3bit8(&self) -> TokenField_f3op3bit8 {
        let inner_value = self.read_u8::<false>(5, 0, 1).unwrap();
        TokenField_f3op3bit8(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op3bit9(&self) -> TokenField_f3op3bit9 {
        let inner_value = self.read_u8::<false>(5, 1, 1).unwrap();
        TokenField_f3op3bit9(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op1RdPairHi(&self) -> TokenField_f3op1RdPairHi {
        let inner_value = self.read_u8::<false>(0, 5, 3).unwrap();
        TokenField_f3op1RdPairHi(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldf3op2RdHi(&self) -> TokenField_f3op2RdHi {
        let inner_value = self.read_u8::<false>(2, 4, 4).unwrap();
        TokenField_f3op2RdHi(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1hi7(&self) -> TokenField_ldswop1hi7 {
        let inner_value = self.read_u8::<false>(1, 1, 7).unwrap();
        TokenField_ldswop1hi7(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop2hi7(&self) -> TokenField_ldswop2hi7 {
        let inner_value = self.read_u8::<false>(5, 1, 7).unwrap();
        TokenField_ldswop2hi7(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1low4(&self) -> TokenField_ldswop1low4 {
        let inner_value = self.read_u8::<false>(0, 0, 4).unwrap();
        TokenField_ldswop1low4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop2low4(&self) -> TokenField_ldswop2low4 {
        let inner_value = self.read_u8::<false>(4, 0, 4).unwrap();
        TokenField_ldswop2low4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1bits5to8(&self) -> TokenField_ldswop1bits5to8 {
        let inner_value = self.read_u16::<false>(0, 5, 4).unwrap();
        TokenField_ldswop1bits5to8(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop2bits5to8(&self) -> TokenField_ldswop2bits5to8 {
        let inner_value = self.read_u16::<false>(4, 5, 4).unwrap();
        TokenField_ldswop2bits5to8(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1bit4(&self) -> TokenField_ldswop1bit4 {
        let inner_value = self.read_u8::<false>(0, 4, 1).unwrap();
        TokenField_ldswop1bit4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop2bit4(&self) -> TokenField_ldswop2bit4 {
        let inner_value = self.read_u8::<false>(4, 4, 1).unwrap();
        TokenField_ldswop2bit4(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1bit16(&self) -> TokenField_ldswop1bit16 {
        let inner_value = self.read_u8::<false>(2, 0, 1).unwrap();
        TokenField_ldswop1bit16(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop2bit16(&self) -> TokenField_ldswop2bit16 {
        let inner_value = self.read_u8::<false>(6, 0, 1).unwrap();
        TokenField_ldswop2bit16(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1imm15(&self) -> TokenField_ldswop1imm15 {
        let inner_value = self.read_u16::<false>(2, 1, 15).unwrap();
        TokenField_ldswop1imm15(u16::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop2imm15(&self) -> TokenField_ldswop2imm15 {
        let inner_value = self.read_u16::<false>(6, 1, 15).unwrap();
        TokenField_ldswop2imm15(u16::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1imm6(&self) -> TokenField_ldswop1imm6 {
        let inner_value = self.read_u8::<false>(2, 1, 6).unwrap();
        TokenField_ldswop1imm6(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop2imm6(&self) -> TokenField_ldswop2imm6 {
        let inner_value = self.read_u8::<false>(6, 1, 6).unwrap();
        TokenField_ldswop2imm6(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1imm16(&self) -> TokenField_ldswop1imm16 {
        let inner_value = self.read_u16::<false>(2, 0, 16).unwrap();
        TokenField_ldswop1imm16(u16::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop2imm16(&self) -> TokenField_ldswop2imm16 {
        let inner_value = self.read_u16::<false>(6, 0, 16).unwrap();
        TokenField_ldswop2imm16(u16::try_from(inner_value).unwrap())
    }
    fn TokenFieldldswop1RdPair(&self) -> TokenField_ldswop1RdPair {
        let inner_value = self.read_u16::<false>(0, 5, 4).unwrap();
        TokenField_ldswop1RdPair(u8::try_from(inner_value).unwrap())
    }
    fn TokenFieldstswop2RdPair(&self) -> TokenField_stswop2RdPair {
        let inner_value = self.read_u16::<false>(4, 5, 4).unwrap();
        TokenField_stswop2RdPair(u8::try_from(inner_value).unwrap())
    }
}
#[derive(Clone, Copy, Debug)]
pub enum Register {
...
#[derive(Clone, Debug)]
struct break_instructionVar0 {}
impl break_instructionVar0 {
    fn display_extend<T>(
        &self,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38296i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct clc_instructionVar1 {}
impl clc_instructionVar1 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38024i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct clh_instructionVar2 {}
impl clh_instructionVar2 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38104i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
impl cli_instructionVar3 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38136i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct cln_instructionVar4 {}
impl cln_instructionVar4 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38056i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct cls_instructionVar5 {}
impl cls_instructionVar5 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38088i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct clt_instructionVar6 {}
impl clt_instructionVar6 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38120i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct clv_instructionVar7 {}
impl clv_instructionVar7 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38072i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct clz_instructionVar8 {}
impl clz_instructionVar8 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38040i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct icall_instructionVar9 {}
impl icall_instructionVar9 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38153i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct ijmp_instructionVar10 {}
impl ijmp_instructionVar10 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 37897i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct lpm_instructionVar11 {}
impl lpm_instructionVar11 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38344i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct nop_instructionVar12 {}
impl nop_instructionVar12 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 0i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct rcall_instructionVar13 {}
impl rcall_instructionVar13 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi4().disassembly() != 13i128 {
            return None;
        }
        if token_parser.TokenFieldoplow12().disassembly() != 0i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct ret_instructionVar14 {}
impl ret_instructionVar14 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38152i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct reti_instructionVar15 {}
impl reti_instructionVar15 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38168i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct sleep_instructionVar16 {}
impl sleep_instructionVar16 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38280i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct spm_instructionVar17 {}
impl spm_instructionVar17 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38376i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct spm_instructionVar18 {
    SpmPlus: TableSpmPlus,
}
impl spm_instructionVar18 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38392i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct wdr_instructionVar19 {}
impl wdr_instructionVar19 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi16().disassembly() != 38312i128 {
            return None;
        }
        pattern_len += block_0_len;
        tokens_current =
...
#[derive(Clone, Debug)]
struct bclr_instructionVar20 {
    op4to6_flag: TokenField_op4to6_flag,
}
impl bclr_instructionVar20 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi9().disassembly() != 297i128 {
            return None;
        }
        if token_parser.TokenFieldoplow4().disassembly() != 4i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct bset_instructionVar21 {
    op4to6_flag: TokenField_op4to6_flag,
}
impl bset_instructionVar21 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi9().disassembly()
            != u32::try_from(1i128)
                .ok()
                .map(|shl| 148i128.checked_shl(shl))
                .flatten()
                .unwrap_or(0)
        {
            return None;
        }
        if token_parser.TokenFieldoplow4().disassembly() != 8i128 {
            return None;
        }
        let op4to6_flag = token_parser.TokenFieldop4to6_flag();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct des_instructionVar22 {
    op4to7: TokenField_op4to7,
}
impl des_instructionVar22 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 148i128 {
            return None;
        }
        if token_parser.TokenFieldoplow4().disassembly() != 11i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct fracmul_instructionVar23 {
    RdHi: TokenField_RdHi,
    RrHi: TokenField_RrHi,
}
impl fracmul_instructionVar23 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi9().disassembly() != 6i128 {
            return None;
        }
        if token_parser.TokenFieldopbit3().disassembly() != 1i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct fracmuls_instructionVar24 {
    RdHi: TokenField_RdHi,
    RrHi: TokenField_RrHi,
}
impl fracmuls_instructionVar24 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi9().disassembly() != 7i128 {
            return None;
        }
        if token_parser.TokenFieldopbit3().disassembly() != 0i128 {
            return None;
        }
        let RdHi = token_parser.TokenFieldRdHi();
        let RrHi = token_parser.TokenFieldRrHi();
...
#[derive(Clone, Debug)]
struct fracmulsu_instructionVar25 {
    RdHi: TokenField_RdHi,
    RrHi: TokenField_RrHi,
}
impl fracmulsu_instructionVar25 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct mulsu_instructionVar26 {
    RdHi3: TokenField_RdHi3,
    RrHi3: TokenField_RrHi3,
}
impl mulsu_instructionVar26 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 3i128 {
            return None;
        }
        if token_parser.TokenFieldopbit7().disassembly() != 0i128 {
            return None;
        }
        if token_parser.TokenFieldopbit3().disassembly() != 0i128 {
            return None;
...
#[derive(Clone, Debug)]
struct ser_instructionVar27 {
    RdHi: TokenField_RdHi,
}
impl ser_instructionVar27 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 239i128 {
            return None;
        }
        if token_parser.TokenFieldoplow4().disassembly() != 15i128 {
            return None;
        }
        let RdHi = token_parser.TokenFieldRdHi();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct adiw_instructionVar28 {
    Rdw2: TokenField_Rdw2,
    K6: TableK6,
}
impl adiw_instructionVar28 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 150i128 {
            return None;
        }
...
impl asr_instructionVar29 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 74i128 {
            return None;
        }
        if token_parser.TokenFieldoplow4().disassembly() != 5i128 {
            return None;
        }
...
impl dec_instructionVar30 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow4().disassembly() != 10i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct in_instructionVar31 {
    RdFull: TokenField_RdFull,
}
impl in_instructionVar31 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi5().disassembly() != 22i128 {
            return None;
        }
        if token_parser.TokenFieldop9to10().disassembly() != 3i128 {
            return None;
        }
        if token_parser.TokenFieldoplow4().disassembly() != 13i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct in_instructionVar32 {
    RdFull: TokenField_RdFull,
}
impl in_instructionVar32 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow4().disassembly() != 14i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct inc_instructionVar34 {
    RdFull: TokenField_RdFull,
}
impl inc_instructionVar34 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow4().disassembly() != 3i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct lac_instructionVar35 {
    RdFull: TokenField_RdFull,
}
impl lac_instructionVar35 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 73i128 {
            return None;
        }
        if token_parser.TokenFieldoplow4().disassembly() != 6i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct las_instructionVar36 {
    RdFull: TokenField_RdFull,
}
impl las_instructionVar36 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct lat_instructionVar37 {
    RdFull: TokenField_RdFull,
}
impl lat_instructionVar37 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow4().disassembly() != 7i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct ld_instructionVar38 {
    RdFull: TokenField_RdFull,
}
impl ld_instructionVar38 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 72i128 {
            return None;
        }
        if token_parser.TokenFieldoplow4().disassembly() != 12i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
impl lds_instructionVar39 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow4().disassembly() != 0i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct lpm_instructionVar40 {
    RdFull: TokenField_RdFull,
}
impl lpm_instructionVar40 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldop1to3().disassembly() != 2i128 {
            return None;
        }
        if token_parser.TokenFieldopbit0().disassembly() != 0i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct lpm_instructionVar41 {
    RdFull: TokenField_RdFull,
    LpmPlus: TableLpmPlus,
}
impl lpm_instructionVar41 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldopbit0().disassembly() != 1i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct lsr_instructionVar42 {
    RdFull: TokenField_RdFull,
}
impl lsr_instructionVar42 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct neg_instructionVar43 {
    RdFull: TokenField_RdFull,
}
impl neg_instructionVar43 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow4().disassembly() != 1i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct out_instructionVar44 {
    RdFull: TokenField_RdFull,
}
impl out_instructionVar44 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi5().disassembly() != 23i128 {
            return None;
        }
        if token_parser.TokenFieldop9to10().disassembly() != 3i128 {
            return None;
...
#[derive(Clone, Debug)]
struct out_instructionVar45 {
    RdFull: TokenField_RdFull,
}
impl out_instructionVar45 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct pop_instructionVar47 {
    RdFull: TokenField_RdFull,
}
impl pop_instructionVar47 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct push_instructionVar48 {
    RdFull: TokenField_RdFull,
}
impl push_instructionVar48 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct ror_instructionVar49 {
    RdFull: TokenField_RdFull,
}
impl ror_instructionVar49 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct st_instructionVar50 {
    RdFull: TokenField_RdFull,
}
impl st_instructionVar50 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct swap_instructionVar52 {
    RdFull: TokenField_RdFull,
}
impl swap_instructionVar52 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow4().disassembly() != 2i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
        pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct xch_instructionVar53 {
    RdFull: TokenField_RdFull,
}
impl xch_instructionVar53 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct call_instructionVar54 {
    abs22dst: Tableabs22dst,
}
impl call_instructionVar54 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut sub_pattern_c47 = |tokens: &[u8], context_param: &mut T| {
            ...
            if token_parser.TokenFieldop1to3().disassembly() != 7i128 {
                return None;
            }
            pattern_len += block_0_len;
...
#[derive(Clone, Debug)]
struct jmp_instructionVar55 {
    abs22dst: Tableabs22dst,
}
impl jmp_instructionVar55 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut sub_pattern_c47 = |tokens: &[u8], context_param: &mut T| {
            ...
            if token_parser.TokenFieldop1to3().disassembly() != 6i128 {
                return None;
            }
            pattern_len += block_0_len;
            tokens = &tokens[usize::try_from(block_0_len).unwrap()..];
...
#[derive(Clone, Debug)]
struct bld_instructionVar56 {
    RdFull: TokenField_RdFull,
    oplow3: TokenField_oplow3,
}
impl bld_instructionVar56 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 124i128 {
            return None;
        }
        if token_parser.TokenFieldopbit3().disassembly() != 0i128 {
            return None;
...
#[derive(Clone, Debug)]
struct bst_instructionVar57 {
    RdFull: TokenField_RdFull,
    oplow3: TokenField_oplow3,
}
impl bst_instructionVar57 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 125i128 {
            return None;
        }
        if token_parser.TokenFieldopbit3().disassembly() != 0i128 {
            return None;
...
#[derive(Clone, Debug)]
struct cbi_instructionVar58 {
    oplow3: TokenField_oplow3,
    Aio5: TableAio5,
}
impl cbi_instructionVar58 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 152i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct ld_instructionVar59 {
    RdFull: TokenField_RdFull,
    RstPtr: TokenField_RstPtr,
}
impl ld_instructionVar59 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 64i128 {
            return None;
        }
        if token_parser.TokenFieldoplow3().disassembly() != 0i128 {
            return None;
        }
        let RdFull = token_parser.TokenFieldRdFull();
...
#[derive(Clone, Debug)]
struct st_instructionVar60 {
    RstPtr: TokenField_RstPtr,
    RdFull: TokenField_RdFull,
}
impl st_instructionVar60 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 65i128 {
            return None;
        }
        if token_parser.TokenFieldoplow3().disassembly() != 0i128 {
            return None;
...
impl ld_instructionVar61 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow2().disassembly() != 1i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct ld_instructionVar62 {
    RdFull: TokenField_RdFull,
    LdPredec: TableLdPredec,
}
impl ld_instructionVar62 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldoplow2().disassembly() != 2i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct movw_instructionVar63 {
    Rdw4: TokenField_Rdw4,
    Rrw4: TokenField_Rrw4,
}
impl movw_instructionVar63 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 1i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct muls_instructionVar64 {
    RdHi: TokenField_RdHi,
    RrHi: TokenField_RrHi,
}
impl muls_instructionVar64 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 2i128 {
            return None;
        }
        let RdHi = token_parser.TokenFieldRdHi();
        let RrHi = token_parser.TokenFieldRrHi();
...
#[derive(Clone, Debug)]
struct sbi_instructionVar65 {
    oplow3: TokenField_oplow3,
    Aio5: TableAio5,
}
impl sbi_instructionVar65 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 154i128 {
            return None;
        }
        let Aio5 = if let Some((len, table)) =
            TableAio5::parse(tokens_current, &mut context_instance, inst_start)
...
#[derive(Clone, Debug)]
struct sbic_instructionVar66 {
    oplow3: TokenField_oplow3,
    Aio5: TableAio5,
}
impl sbic_instructionVar66 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        global_set.set_useSkipCond(
            Some(inst_next),
            context.register().read_useSkipCond_disassembly().unwrap(),
        );
        let extend: [DisplayElement; 2usize] = [
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 153i128 {
            return None;
        }
        let tmp = 1i128;
        context_instance
...
#[derive(Clone, Debug)]
struct sbis_instructionVar67 {
    oplow3: TokenField_oplow3,
    Aio5: TableAio5,
}
impl sbis_instructionVar67 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 155i128 {
            return None;
        }
        let tmp = 1i128;
        context_instance
...
#[derive(Clone, Debug)]
struct sbiw_instructionVar68 {
    Rdw2: TokenField_Rdw2,
    K6: TableK6,
}
impl sbiw_instructionVar68 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi8().disassembly() != 151i128 {
            return None;
        }
        let K6 = if let Some((len, table)) =
            TableK6::parse(tokens_current, &mut context_instance, inst_start)
...
#[derive(Clone, Debug)]
struct sbrc_instructionVar69 {
    RdFull: TokenField_RdFull,
    oplow3: TokenField_oplow3,
}
impl sbrc_instructionVar69 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 126i128 {
            return None;
        }
        if token_parser.TokenFieldopbit3().disassembly() != 0i128 {
            return None;
...
#[derive(Clone, Debug)]
struct sbrs_instructionVar70 {
    RdFull: TokenField_RdFull,
    oplow3: TokenField_oplow3,
}
impl sbrs_instructionVar70 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi7().disassembly() != 127i128 {
            return None;
        }
        if token_parser.TokenFieldopbit3().disassembly() != 0i128 {
            return None;
...
#[derive(Clone, Debug)]
struct st_instructionVar71 {
    RdFull: TokenField_RdFull,
    StPlus: TableStPlus,
}
impl st_instructionVar71 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct st_instructionVar72 {
    RdFull: TokenField_RdFull,
    StPredec: TableStPredec,
}
impl st_instructionVar72 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct com_instructionVar73 {
    RdFull: TokenField_RdFull,
}
impl com_instructionVar73 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct adc_instructionVar74 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl adc_instructionVar74 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 7i128 {
            return None;
        }
...
impl add_instructionVar75 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 3i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
impl and_instructionVar76 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 8i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct brbc_instructionVar77 {
    oplow3_flag: TokenField_oplow3_flag,
    rel7dst: Tablerel7dst,
}
impl brbc_instructionVar77 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 61i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct brbs_instructionVar78 {
    oplow3_flag: TokenField_oplow3_flag,
    rel7dst: Tablerel7dst,
}
impl brbs_instructionVar78 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 60i128 {
            return None;
        }
        let rel7dst = if let Some((len, table)) = Tablerel7dst::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct cp_instructionVar79 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl cp_instructionVar79 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 5i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct cpc_instructionVar80 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl cpc_instructionVar80 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 1i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct cpse_instructionVar81 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl cpse_instructionVar81 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 4i128 {
            return None;
        }
        let tmp = 1i128;
        context_instance
...
#[derive(Clone, Debug)]
struct eor_instructionVar82 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl eor_instructionVar82 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 9i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
impl mov_instructionVar83 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 11i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct mul_instructionVar84 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl mul_instructionVar84 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 39i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct or_instructionVar85 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl or_instructionVar85 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 10i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct sbc_instructionVar86 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl sbc_instructionVar86 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 2i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct sub_instructionVar87 {
    RdFull: TokenField_RdFull,
    RrFull: TableRrFull,
}
impl sub_instructionVar87 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi6().disassembly() != 6i128 {
            return None;
        }
        let RrFull = if let Some((len, table)) = TableRrFull::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct in_instructionVar88 {
    RdFull: TokenField_RdFull,
    Aio6: TableAio6,
}
impl in_instructionVar88 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
impl lds_instructionVar89 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi5().disassembly() != 20i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct out_instructionVar90 {
    RdFull: TokenField_RdFull,
    Aio6: TableAio6,
}
impl out_instructionVar90 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct sts_instructionVar91 {
    RdHi: TokenField_RdHi,
    K7addr: TableK7addr,
}
impl sts_instructionVar91 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi5().disassembly() != 21i128 {
            return None;
        }
        let K7addr = if let Some((len, table)) = TableK7addr::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct andi_instructionVar92 {
    RdHi: TokenField_RdHi,
    K8: TableK8,
}
impl andi_instructionVar92 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi4().disassembly() != 7i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct cpi_instructionVar93 {
    RdHi: TokenField_RdHi,
    K8: TableK8,
}
impl cpi_instructionVar93 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi4().disassembly() != 3i128 {
            return None;
        }
        let K8 = if let Some((len, table)) =
            TableK8::parse(tokens_current, &mut context_instance, inst_start)
...
#[derive(Clone, Debug)]
struct ldd_instructionVar94 {
    RdFull: TokenField_RdFull,
    LddYZq: TableLddYZq,
}
impl ldd_instructionVar94 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi2().disassembly() != 2i128 {
            return None;
        }
        if token_parser.TokenFieldopbit12().disassembly() != 0i128 {
            return None;
        }
        if token_parser.TokenFieldopbit9().disassembly() != 0i128 {
            return None;
        }
...
impl ldi_instructionVar95 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi4().disassembly() != 14i128 {
            return None;
        }
        let K8 = if let Some((len, table)) =
            TableK8::parse(tokens_current, &mut context_instance, inst_start)
...
#[derive(Clone, Debug)]
struct ori_instructionVar96 {
    RdHi: TokenField_RdHi,
    K8: TableK8,
}
impl ori_instructionVar96 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi4().disassembly() != 6i128 {
            return None;
        }
        let K8 = if let Some((len, table)) =
            TableK8::parse(tokens_current, &mut context_instance, inst_start)
...
#[derive(Clone, Debug)]
struct rcall_instructionVar97 {
    rel12dst: Tablerel12dst,
}
impl rcall_instructionVar97 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
...
#[derive(Clone, Debug)]
struct rjmp_instructionVar98 {
    rel12dst: Tablerel12dst,
}
impl rjmp_instructionVar98 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi4().disassembly() != 12i128 {
            return None;
        }
        let rel12dst = if let Some((len, table)) = Tablerel12dst::parse(
            tokens_current,
...
#[derive(Clone, Debug)]
struct sbci_instructionVar99 {
    RdHi: TokenField_RdHi,
    K8: TableK8,
}
impl sbci_instructionVar99 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi4().disassembly() != 4i128 {
            return None;
        }
        let K8 = if let Some((len, table)) =
            TableK8::parse(tokens_current, &mut context_instance, inst_start)
...
#[derive(Clone, Debug)]
struct std_instructionVar100 {
    RdFull: TokenField_RdFull,
    StdYZq: TableStdYZq,
}
impl std_instructionVar100 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldopbit9().disassembly() != 1i128 {
            return None;
        }
...
#[derive(Clone, Debug)]
struct subi_instructionVar101 {
    RdHi: TokenField_RdHi,
    K8: TableK8,
}
impl subi_instructionVar101 {
    fn display_extend<T>(
        &self,
        display: &mut Vec<DisplayElement>,
        context: &T,
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldophi4().disassembly() != 5i128 {
            return None;
        }
        let K8 = if let Some((len, table)) =
            TableK8::parse(tokens_current, &mut context_instance, inst_start)
...
enum Tableinstruction {
    Var0(break_instructionVar0),
    Var1(clc_instructionVar1),
    Var2(clh_instructionVar2),
    Var3(cli_instructionVar3),
    Var4(cln_instructionVar4),
    Var5(cls_instructionVar5),
    Var6(clt_instructionVar6),
    Var7(clv_instructionVar7),
    Var8(clz_instructionVar8),
    Var9(icall_instructionVar9),
    Var10(ijmp_instructionVar10),
    Var11(lpm_instructionVar11),
    Var12(nop_instructionVar12),
    Var13(rcall_instructionVar13),
    Var14(ret_instructionVar14),
    Var15(reti_instructionVar15),
    Var16(sleep_instructionVar16),
    Var17(spm_instructionVar17),
    Var18(spm_instructionVar18),
    Var19(wdr_instructionVar19),
    Var20(bclr_instructionVar20),
    Var21(bset_instructionVar21),
    Var22(des_instructionVar22),
    Var23(fracmul_instructionVar23),
    Var24(fracmuls_instructionVar24),
    Var25(fracmulsu_instructionVar25),
    Var26(mulsu_instructionVar26),
    Var27(ser_instructionVar27),
    Var28(adiw_instructionVar28),
    Var29(asr_instructionVar29),
    Var30(dec_instructionVar30),
    Var31(in_instructionVar31),
    Var32(in_instructionVar32),
    Var33(in_instructionVar33),
    Var34(inc_instructionVar34),
    Var35(lac_instructionVar35),
    Var36(las_instructionVar36),
    Var37(lat_instructionVar37),
    Var38(ld_instructionVar38),
    Var39(lds_instructionVar39),
    Var40(lpm_instructionVar40),
    Var41(lpm_instructionVar41),
    Var42(lsr_instructionVar42),
    Var43(neg_instructionVar43),
    Var44(out_instructionVar44),
    Var45(out_instructionVar45),
    Var46(out_instructionVar46),
    Var47(pop_instructionVar47),
    Var48(push_instructionVar48),
    Var49(ror_instructionVar49),
    Var50(st_instructionVar50),
    Var51(sts_instructionVar51),
    Var52(swap_instructionVar52),
    Var53(xch_instructionVar53),
    Var54(call_instructionVar54),
    Var55(jmp_instructionVar55),
    Var56(bld_instructionVar56),
    Var57(bst_instructionVar57),
    Var58(cbi_instructionVar58),
    Var59(ld_instructionVar59),
    Var60(st_instructionVar60),
    Var61(ld_instructionVar61),
    Var62(ld_instructionVar62),
    Var63(movw_instructionVar63),
    Var64(muls_instructionVar64),
    Var65(sbi_instructionVar65),
    Var66(sbic_instructionVar66),
    Var67(sbis_instructionVar67),
    Var68(sbiw_instructionVar68),
    Var69(sbrc_instructionVar69),
    Var70(sbrs_instructionVar70),
    Var71(st_instructionVar71),
    Var72(st_instructionVar72),
    Var73(com_instructionVar73),
    Var74(adc_instructionVar74),
    Var75(add_instructionVar75),
    Var76(and_instructionVar76),
    Var77(brbc_instructionVar77),
    Var78(brbs_instructionVar78),
    Var79(cp_instructionVar79),
    Var80(cpc_instructionVar80),
    Var81(cpse_instructionVar81),
    Var82(eor_instructionVar82),
    Var83(mov_instructionVar83),
    Var84(mul_instructionVar84),
    Var85(or_instructionVar85),
    Var86(sbc_instructionVar86),
    Var87(sub_instructionVar87),
    Var88(in_instructionVar88),
    Var89(lds_instructionVar89),
    Var90(out_instructionVar90),
    Var91(sts_instructionVar91),
    Var92(andi_instructionVar92),
    Var93(cpi_instructionVar93),
    Var94(ldd_instructionVar94),
    Var95(ldi_instructionVar95),
    Var96(ori_instructionVar96),
    Var97(rcall_instructionVar97),
    Var98(rjmp_instructionVar98),
    Var99(sbci_instructionVar99),
    Var100(std_instructionVar100),
    Var101(subi_instructionVar101),
...
impl Tableinstruction {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if let Some((inst_len, parsed)) = break_instructionVar0::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = clc_instructionVar1::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = clh_instructionVar2::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = cln_instructionVar4::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = cls_instructionVar5::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = clt_instructionVar6::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = clv_instructionVar7::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = clz_instructionVar8::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = icall_instructionVar9::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ijmp_instructionVar10::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = lpm_instructionVar11::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = nop_instructionVar12::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = rcall_instructionVar13::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ret_instructionVar14::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = reti_instructionVar15::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sleep_instructionVar16::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = spm_instructionVar17::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = spm_instructionVar18::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = wdr_instructionVar19::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = bclr_instructionVar20::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = bset_instructionVar21::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = des_instructionVar22::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = fracmul_instructionVar23::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = fracmuls_instructionVar24::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = fracmulsu_instructionVar25::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = mulsu_instructionVar26::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ser_instructionVar27::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = adiw_instructionVar28::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = dec_instructionVar30::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = in_instructionVar31::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = in_instructionVar32::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = in_instructionVar33::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = inc_instructionVar34::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = lac_instructionVar35::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = las_instructionVar36::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = lat_instructionVar37::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ld_instructionVar38::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = lpm_instructionVar40::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = lpm_instructionVar41::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = lsr_instructionVar42::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = neg_instructionVar43::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = out_instructionVar44::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = out_instructionVar45::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = out_instructionVar46::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = pop_instructionVar47::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = push_instructionVar48::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ror_instructionVar49::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = st_instructionVar50::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = swap_instructionVar52::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = xch_instructionVar53::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = call_instructionVar54::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = jmp_instructionVar55::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = bld_instructionVar56::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = bst_instructionVar57::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = cbi_instructionVar58::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ld_instructionVar59::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = st_instructionVar60::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ld_instructionVar61::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ld_instructionVar62::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = movw_instructionVar63::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = muls_instructionVar64::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sbi_instructionVar65::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sbic_instructionVar66::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sbis_instructionVar67::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sbiw_instructionVar68::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sbrc_instructionVar69::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sbrs_instructionVar70::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = st_instructionVar71::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = st_instructionVar72::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = com_instructionVar73::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = adc_instructionVar74::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = add_instructionVar75::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = and_instructionVar76::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = brbc_instructionVar77::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = brbs_instructionVar78::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = cp_instructionVar79::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = cpc_instructionVar80::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = cpse_instructionVar81::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = eor_instructionVar82::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = mul_instructionVar84::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = or_instructionVar85::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sbc_instructionVar86::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sub_instructionVar87::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = in_instructionVar88::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = lds_instructionVar89::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = out_instructionVar90::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sts_instructionVar91::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = andi_instructionVar92::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = cpi_instructionVar93::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ldd_instructionVar94::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = ori_instructionVar96::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = rcall_instructionVar97::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = rjmp_instructionVar98::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = sbci_instructionVar99::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = std_instructionVar100::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
        ...
        if let Some((inst_len, parsed)) = subi_instructionVar101::parse(
            tokens_param,
            &mut context_current,
            inst_start,
        ) {
...
impl RrFullVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.TokenFieldRrHiLowSel().disassembly() != 1i128 {
            return None;
        }
        let RrHi = token_parser.TokenFieldRrHi();
        pattern_len += block_0_len;
...
impl RrFullVar1 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        if token_parser.TokenFieldRrHiLowSel().disassembly() != 0i128 {
            return None;
        }
...
impl op1RrPairVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        if token_parser.TokenFieldop1RrPairSel().disassembly() != 1i128 {
            return None;
        }
...
impl op1RrPairVar1 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 4u64 as u16;
        let token_parser = <TokenParser<4usize>>::new(tokens_current)?;
        if token_parser.TokenFieldop1RrPairSel().disassembly() != 0i128 {
            return None;
        }
...
impl K8Var0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        calc_val = (u32::try_from(4i128)
            .ok()
            .map(|shl| self.op8to11.disassembly().checked_shl(shl))
            .flatten()
            .unwrap_or(0)
...
impl rel7addrVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        let extend: [DisplayElement; 1usize] =
            [DisplayElement::Number(true, calc_rel)];
        display.extend_from_slice(&extend);
    }
    fn parse<T>(
        mut tokens_current: &[u8],
...
impl rel7dstVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        calc_byteOffset = u32::try_from(1i128)
            ...
            .unwrap_or(0);
        let extend: [DisplayElement; 1usize] =
            [DisplayElement::Number(true, calc_byteOffset)];
        display.extend_from_slice(&extend);
    }
    fn parse<T>(
        mut tokens_current: &[u8],
...
impl abs22addrVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        calc_loc = ((u32::try_from(17i128)
            .ok()
            .map(|shl| self.op4to8.disassembly().checked_shl(shl))
            .flatten()
            .unwrap_or(0)
            | u32::try_from(16i128)
                .ok()
                .map(|shl| self.opbit0.disassembly().checked_shl(shl))
                .flatten()
                .unwrap_or(0))
...
impl K6Var0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        calc_val = (u32::try_from(4i128)
            .ok()
            .map(|shl| self.op6to7.disassembly().checked_shl(shl))
            .flatten()
            .unwrap_or(0)
...
impl K7addrVar0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        calc_val = (((u32::try_from(7i128)
            .ok()
            .map(|shl| (1i128 ^ self.opbit8.disassembly()).checked_shl(shl))
            .flatten()
            .unwrap_or(0)
            | u32::try_from(6i128)
                .ok()
                .map(|shl| self.opbit8.disassembly().checked_shl(shl))
                .flatten()
                .unwrap_or(0))
            | u32::try_from(4i128)
                .ok()
                .map(|shl| self.op9to10.disassembly().checked_shl(shl))
                .flatten()
                .unwrap_or(0))
            | self.oplow4.disassembly());
        let extend: [DisplayElement; 1usize] =
        ...
        T: ContextTrait + Clone,
    {
        ...
        calc_val = (((u32::try_from(7i128)
            .ok()
            .map(|shl| {
                (1i128 ^ token_parser.TokenFieldopbit8().disassembly())
                    .checked_shl(shl)
            })
            .flatten()
            .unwrap_or(0)
...
impl Aio5Var0 {
    ...
    {
        let mut calc_val: i128 = 0;
        calc_val = (self.op3to7.disassembly() | 0i128).wrapping_add(32i128);
        let extend: [DisplayElement; 1usize] =
            [DisplayElement::Number(true, calc_val)];
        display.extend_from_slice(&extend);
    }
        ...
        T: ContextTrait + Clone,
    {
        ...
        let mut block_0_len = 2u64 as u16;
        let token_parser = <TokenParser<2usize>>::new(tokens_current)?;
        calc_val = (token_parser.TokenFieldop3to7().disassembly() | 0i128)
            .wrapping_add(32i128);
...
impl q6Var0 {
        ...
        T: ContextTrait + Clone,
    {
        ...
        calc_val = ((u32::try_from(5i128)
            .ok()
            .map(|shl| self.opbit13.disassembly().checked_shl(shl))
            .flatten()
            .unwrap_or(0)
            | u32::try_from(3i128)
                .ok()
                .map(|shl| self.op10to11.disassembly().checked_shl(shl))
                .flatten()
                .unwrap_or(0))
